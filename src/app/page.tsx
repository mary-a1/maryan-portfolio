        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              ...
              <BlurFadeText
                className="text-lg max-w-[600px] tracking-tighter text-muted-foreground"
                delay={BLUR_FADE_DELAY}
      ...
      <section id="work">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 5}>
            <h2 className="text-xl font-bold section-title">Work Experience</h2>
          </BlurFade>
      ...
      <section id="education">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 7}>
            <h2 className="text-xl font-bold section-title">Education</h2>
          </BlurFade>
        ...
        <div className="space-y-12 w-full py-12">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 max-w-[900px] mx-auto ">
            {DATA.projects.map((project, id) => (
              ...
              >
                <div className={id === 0 ? "sm:col-span-2" : ""}>
                  <ProjectCard
                    href={project.href}
                    title={project.title}
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 16}>
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Have a project in mind or just want to chat about product? <br />
                Please reach out and I'm excited to hear from you! 😆
              </p>
            </div>
          </BlurFade>
        </div>
