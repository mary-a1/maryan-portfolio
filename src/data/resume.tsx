...
export const DATA = {
  ...
  description:
    "Product Analyst working at the intersection of UX, data, and technical product in regulated fintech environments.",
  summary:
  ...
  avatarUrl: "/me.png",
  skills: [
    // Product / Business Skills (static, primary)
    "Product Strategy",
    ...
    // Technical Skills (floating, secondary)
    "TypeScript",
    "JavaScript",
    "React",
    "Next.js",
  ...
  work: [
    {
      ...
      location: "Toronto, ON",
      title: "Product Analyst Intern — Everyday Banking",
      logoUrl: "/simplii.png",
      start: "May 2025",
      end: "Dec 2025",
      description:
